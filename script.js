document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function(event) {
        ...
        let alertIcon = '';
        if (score === 20) {
            alertMessage = `Félicitations ! Votre score est (${score}/20 points).`;
            ...
            alertMessage = `Bien joué ! Votre score est (${score}/20 points).`;
            alertClass = 'alert';
            ...
            alertMessage = `Dommage, Votre score est (${score}/20 points).`;
